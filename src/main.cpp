...
const string strMessageMagic = "Csp Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Csp
    bool fStrictPayToScriptHash = true; // Always active in Csp
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Csp", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "17 January 2018 10:30AM";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1516173377;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 13874516;
        ...
        assert(block.hashMerkleRoot == uint256("0xe3e78b947fc6a3541f4214d2a4a562a2d3fa97b773e4221325a97f4e83e2385f"));
